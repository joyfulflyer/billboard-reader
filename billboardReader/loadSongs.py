...
def grabBetween(startYear, endYear):
	...
	currentYear = 0
	printProgressBar.printProgressBar(0, assumedMax, prefix="Progress: ", suffix=" Complete")
	def onYearDone():
		nonlocal currentYear
		currentYear += 1
		printProgressBar.printProgressBar(currentYear, assumedMax, prefix="Progress: ", suffix=" Complete")
